  ...
  try {
    ...
    if (error instanceof Error) {
      ...
      if (message.includes("not authorised") || message.includes("not authorized")) {
        errorMessage = "You are not authorized to approve riders. Only admins can perform this action.";
...
export async function getContractBalance(
  ...
  try {
    ...
    if (error instanceof Error) {
      ...
      if (message.includes("not authorised") || message.includes("not authorized")) {
        errorMessage = "You are not authorized to view contract balance. Only admins can perform this action.";
      } else {
        errorMessage = error.message;
      }
    }
